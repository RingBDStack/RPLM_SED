...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default='/home/lipu/HP_event/cache/twitter12.npy')
    parser.add_argument('--plm_path', type=str, default='/home/lipu/smed/bert-base-uncased/')
    ...
    parser.add_argument('--ckpt_path', type=str, default='/home/lipu/HP_event/ckpt/lora_bert', help='path to checkpoint files')
    parser.add_argument("--eva_data", type=str, default="/home/lipu/HP_event/Eva_data/lora_bert",help="path to Evaluate_datas")
...
def create_trainer(model, optimizer, lr_scheduler, cfg):
    ...
    def _train_step(_, batch):
        ...
        if cfg.lmda1 > 0.:
            loss = loss + cfg.lmda1 * inter_dist_loss + cfg.lmda2 * intra_dist_loss
        optimizer.zero_grad()
        loss.backward()
        optimizer.step()
...
def create_tester(model, cfg, msg_feats, ref_num):
