...
def get_args():
    ...
    parser.add_argument('--ckpt_path', type=str, default='/home/lipu/HP_event/ckpt/', help='path to checkpoint files')
    parser.add_argument("--eva_data", type=str, default="/home/lipu/HP_event/Eva_data/",help="path to Evaluate_datas")
